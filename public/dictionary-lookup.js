// import { FieldFormatRegisty } from '../../../src/plugins/data/public/field_formats_provider/field_formats';
...
function DictionaryLookupProvider(Private) {
  ...
  var FieldFormat = Private(require('../../../src/plugins/data/common/field_formats/field_format'));
...
npSetup.plugins.data.fieldFormats.register([DictionaryLookupProvider]);

npStart.plugins.data.fieldFormats.getType(["DictionaryLookup"]);
